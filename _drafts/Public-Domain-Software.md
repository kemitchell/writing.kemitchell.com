...
Perhaps once or twice a year, someone asks me about "putting software into the public domain".  This is a thing some programmers want to do.  But an increasing number of them have read into, or heard about, concerns about [The Unlicense](https://spdx.org/licenses/Unlicense.html), [CC0](https://creativecommons.org/publicdomain/zero/1.0/), and other forms that purport to get the job done.  Concerns about legal implementation.  Concerns about patents.

Most of these programmers would better use the [Blue Oak Model License](https://blueoakcouncil.org/license/1.0.0).  That's the state of the art for a maximally permissive "give it away" software legal tool.  But it is a license.  And nowhere in its short text will you find the phrase "public domain".

The "public domain" became a cause, as I see it, thanks to activists like Larry Lessig and James Boyle.  But at least here in the US, it remains more policy concept than legal mechanism.  "Public domain" is a way of describing a pattern of legal reality, rather than any legal method you can invoke or bit you can flip.  As a result, framing end goal as "put it in the public domain" can mire people in generalizations, complexities, and rhetoric they really don't need to meet their goals.  Framing as "let people do what they want" focuses practical outcomes, rather than implementation details.

That said, the public domain _is_ a legal idea: the great and growing well of works, ideas, symbols, and designs not encumbered by intellectual property claims.  For example, inventions and works on which patents and copyrights have expired.  And you will find the phrase "public domain" in US court opinions used broadly in this sense.  You will find discussion of copyright "abandonment" used much as activists mean "dedication to the public domain".

But you won't find any well structured process, nor much guidance on how to invoke it, or how to interpret words that seem to want to.  Not in the Copyright Act.  Not in court decisions.
...
Here's from the District of Nevada in _Rimini Street v. Oracle_, <abbr title="Federal Supplement, Third Series, Volume 473, Page 1158">473 F.Supp.3d 1158</abbr>, in 2020:
...
But that is ignoring the reality that in law, a clear if-then only shifts the fight to the inputs.  What's an overt act?  What does it apply to?  What evidence from context---all those pesky "facts" potentially driving the "inquiry"---will push those questions one way or the other?

On top of that, we need to remember that public policy doesn't pull our way.  The point of the Copyright Act, give authors exclusivity, plus the general legal default, aversion to "forfeitures", will haunt us in open-ended "face-specific inquiries".  We'd probably have seen those aversions cited in the decisions quoted above had any of them had actually held a copyright on decision path abandoned.

Where does that leave us?

In terms of recommending a practical and especially standardizable solution---something reliable and repeatable enough that we can tell people to do it by rote, like copying a form license into `LICENSE`---it's hard to get behind sticking "Public Domain" where the copyright notice would go.  It's hard to get behind short, single-sentence statements like "I hereby dedicate this software to the public domain".  It's hard to get behind any terms that travel the pig trail of abandonment exclusively.  Because even if we know abandonment's an outcome we can get, the courts are telling us the path from here to there is a whole lot of undefined behavior.  So far.
...
Note that this bit is conditional.  `IF` the license is being applied in a jurisdiction where that works, `THEN` it's dedicated.  Where it's not, Unlicense falls back on the remaining license parts of its terms.  Insofar as the dedication attempts the same result as the license, where the license is deemed reliable, but the dedication dubious, the dedication is functionally redundant.  It's there for the sake of saying "public domain".

Same for [Creative Commons' CC0](https://creativecommons.org/publicdomain/zero/1.0/legalcode).  It's called a "public domain dedication", but is actually one big "`IF` we can do that, `THEN` do it, `ELSE` here's a permissive license" branch construct.  Its preamble is almost as long as the whole Blue Oak Model License.  Its waiver is longer than Unlicense's.  Its license terms are longer than Blue Oak again.

These forms fall back on licensing because we've comparative mountains of guidance and confidence in it.  Plus the benefits of pervasive familiarity among users, even lumbering corporate ones, who are all used to receiving software license grants from `LICENSE` files.

One cool but temperamental "public domain" car, to show off on the weekends.  Another, less cool, "license" care beside it, to get where needs going reliably.  But why treat `LICENSE` like a two-car garage?

Returning to how we state our goals---in terms of what people can do, rather than abstractly---here's the Blue Oak Model's License's copyright language:
...
Note that Unlicense and CC0 license parts are _not_ equivalent here.  Unlicense inherits MIT's mistake of at best implying, never saying, the word "patent".  CC0's fallback license does say "patent", but specifically to say "no...patent rights...are waived, abandoned, surrendered, licensed or otherwise affected by this document".  In other words, no patent license.  Creative Commons, like its founders, sees "public domain" first and foremost in terms of copyright.  Its mission has long scoped software out, as free software's thing.  Red Hat just [delisted CC0 as a good-go-green license on account of this](https://lwn.net/ml/fedora-legal/CAC1cPGw1xScGAXo-0NRs92zFB7ptRxTt=oCYi0BxfZDfAgUtYQ@mail.gmail.com/).
...
All in, my sense of the Blue Oak Council was that it could be hard to enforce a disclaimer against someone who'd got a copy of some software without any copy of that disclaimer.  Especially if the license terms did nothing to require passing one along.  The operative rules here veer general, evoking the concept of "notice" and the vague-ish principle that, apart from public laws and regulations, people can't be fairly held to terms they weren't made aware of.  There are more specific and impressive sounding ways to articulate that in lawspeak---contractually, constitutionally, in storied maxims of equity---but it's really something more basic, cross-cutting, fundamental.

So a "copies of terms" required it is.

That is different, by the way, than what we'd get by simply using a common license that requires both copies of terms and copies of copyright notices, like MIT, BSD, or Apache 2.0, and then adding a note giving up---"waiving"---the requirement, meaning for both notices and terms.  And in my experience, that does more to confuse than to help.  Especially for those really diligent on license compliance.
