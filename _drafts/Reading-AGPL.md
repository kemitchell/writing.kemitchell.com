---
title: Reading GNU Affero GPL
description: a guided tour for first-timers
series: Line by Line
brief: The trick to paring AGPLv3 down is diffing it with GPLv3 and drilling down from there.  The crux is the first paragraph of section 13.  But even those two sentences make hardly any sense without broader context.  It's not you, dear reader.
tags:
- Open Source
---
...
I could go on.  But I won't.  If you've had a taste and want more, you have a good start on how to find it.  But even if you've made this far, and are ready to think about something else for a few years, congratulations.  This stuff isn't easy.  No one can make it easy without making it at least slightly wrong.
