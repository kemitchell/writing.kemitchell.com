...
Consider the [Developer Certificate of Origin](https://developercertificate.org/).  The DCO isn't a "license agreement" per se.  It's a standardized, public statement made by contributors for the benefit of Linux kernel contributors and users.  The statement, or certificate, confirms that the contributor is licensing their work under the indicated license, and has the rights to do so.  Creating those records gives kernel developers evidence to fight back against claims that source code in the kernel came from someone else, who now wants to sue developers or users for infringement.  [SCO made such claims](https://en.wikipedia.org/wiki/SCO/Linux_controversies), and lack of handy evidence to the contrary wasted a lot of time.  Kernel developers responded by writing and adopting the Developer Certificate of Origin.
...
Affirmative replies create publicly accessible records on GitHub.  Those records address three of the most important goals of CLAs: confirming license terms for each contribution, confirming rights to give the licenses, and creating records of statements by contributors about licensing.  For projects under permissive open source licenses, that's touching all bases.

Many open source developers probably wouldn't think to call this kind of process a "CLA" at all.  They associate "CLA" first and foremost with the hassle of clunky CLA processes, rather than their purpose.  But the very informal CLA process described above is a process by which a contributor (C) agrees (A) to license (L) their contributions, and creates a public, written record of doing so.  It has all the major elements of, and achieves the major goals of, an Apache Individual Contributor License Agreement, though with less formality and specificity.  It differs chiefly by substituting process formalities familiar to developers---Git branches and pull request messages---for those familiar to lawyers---documents and signature pages.  Either way, we end up with evidence to repulse infringement claims.
...
Without a process in place, it's often very hard to establish one.  First just because changing workflows is usually awkward, but also because it's so much harder to educate everyone involved about the need all at once, rather than one by one, as they work through an established process.  It's often _impossible_ to go back and get licensing records for past contributions.  People can't be reached, can't be bothered, or can't feel comfortable giving legal-sounding statements about the circumstances of work they did years ago.  Which explains why projects that start without contributor licensing processes get stuck that way.
...
Second, and more important, this approach encourages hiding contributor licensing from developers, out of sight and out of mind.  Much has been said of open source becoming the new "normal", at least for certain kinds of code used to build software that is not open source.  But open source is awesome because open source is _not_.  Proprietary, closed-source software is the legal and business default.  Giving away valuable work for literally anyone to run with is extraordinary.
...
Ben and I haven't had a good sit-down talk about open source sustainability.  I'd sure love the chance.  In the meantime, I don't want to jump to any conclusions about how he sees the problem.  But reading through his post, I can't help remember a tweet of my own, from a while back:
...
I'm at serious risk of projecting here, but I can't help thinking this implies definitions of "success" and "sustainable" that are valid, but not universally shared.  Projects largely attributable to a single contributor are the norm, and some give faithful service over decades, with few outside patches.  Projects that chew through lead maintainers, replacing burnout casualties with willing new blood, are sustainable only for a very narrow definition of sustainable, from only the user point of view.
...
If a company takes their product open source, solicits outside contribution, and actively recruits those contributing, as MySQL did so notably, in its early days, even heavy-duty CLAs might make perfect sense.  Programmers on payroll---sustaining their contributions in a refreshingly direct, rational way---is worth protecting.  And we know from experience such projects can succeed.

That's definitely not the only way to to do open source, or perhaps the most exciting or fashionable way.  But it is open source.  It's very hard to give general prescriptions for all of open source, or to define "success" or "sustainability" or "quality", without implicit slight to someone or some project very much a part of the community.  Especially in corners of the community remote from our own.
