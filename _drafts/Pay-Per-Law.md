...
What about competitive publishers?  They exist.  Often briefly.  West infamously [sued one for replicating its pagination](https://en.wikisource.org/wiki/West_Publishing_Co._v._Mead_Data_Central,_Inc./Opinion_of_the_Court) back int the day and lost in court.  But other maneuvers, including more original content in the form of annotations and summaries, soon followed, to salt the earth around the fortress.  For most case law, there simply isn't any existing record free of some private company's copyrighted material.  Picking all that salt out, grain by grain, so startups and others can build on public law, has taken [massive effort and resources](https://case.law/), and still isn't free for unrestricted access or use.

The high court is in a unique position to call this out.  I'm glad they did.  But then only meekly, buried in parentheticals in mind-numbingly redundant string citations:
...
This was true in Texas when I lived there, and it's true in California, where I live now.  It's also true that public law libraries---bless their souls---do what they can to buy these pricey resources and make them available for naught.  Where they can, they get deals to make the commercial databases available at their computer stations.  But a two-tier system where some people get to use the Internet, and others get bus passes, gas bills, and access codes at the library is still very much a two-tier system.
