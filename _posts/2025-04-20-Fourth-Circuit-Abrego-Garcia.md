...
Skirting the term ["constitutional crisis"](https://en.wikipedia.org/wiki/Constitutional_crisis).  I share a kind of allergy to that term.  It's way more clear that it means "big drama" than anything more specific---more igniter than useful fuel.  Authors writing earnestly about it nearly always define it some new way, for themselves, if they don't just [avoid it altogether](https://hls.harvard.edu/bibliography/constitutional-showdowns/).  But I'm not aware of a better term for irreconcilable conflicts between branches of government.
