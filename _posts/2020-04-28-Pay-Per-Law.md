...
This was true in Texas when I lived there, and it's true in California, where I live now.  It's also true that public law librarians---bless their noble souls---do what they can to buy these pricey resources and make them available for naught.  Where they can, they get deals to make the commercial databases available at their computer stations.  But a two-tier system where some people get to use the Internet, and others get bus passes, gas bills, and access codes at the library is still very much a two-tier system.
