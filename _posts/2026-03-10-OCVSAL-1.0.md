---
date: 2026-03-10T11:02:02-07:00
...
[Open Core Ventures](https://www.opencoreventures.com/), an open-focused venture capital firm, has published a [new source-available license](https://github.com/OpenCoreVentures/open-core-ventures-source-available-license).  It's short.  Here are notes from my first couple reads through.
...
A built-in CLA, and a very broad one.  This is mixing terminology that we'd typically see in the "feedback" sections of commercial license or SaaS terms with the kind of explicit license-grant language we'd see in a CLA.
...
_Important Correction_: As originally published, this blog post attributed the new license to Heather Meeker.  Heather's firm is [OSS Capital](https://oss.capital/), not Open Core Ventures.  A regrettable and embarrassing mistake!  Thanks to Heather for letting me know.
