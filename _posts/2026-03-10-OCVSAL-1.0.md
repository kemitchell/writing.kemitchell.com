...
[Open Core Ventures](https://www.opencoreventures.com/), an open-focused venture capital firm, has published a new source-available license.  It's short.  Here are notes from my first couple reads through.
...
_Important Correction: As originally published, this blog post attributed the new license to Heather Meeker.  Heather's firm is [OSS Capital](https://oss.capital/), not Open Core Ventures.  A regrettable and embarrassing mistake!  Thanks to Heather for letting me know._
