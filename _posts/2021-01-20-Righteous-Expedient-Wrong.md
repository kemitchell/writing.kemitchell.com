...
I have yet to see OSI back its theory that it can control "open source" via unfair competition claims with legal argument or citations, just vague threats.  I have to yet to find precedents to support those threats, when I found time to go looking.  I know for a fact OSI has access to talent that might know better, if indeed there's anything behind this.  But from where I'm standing, I'd bet they see more to gain from uncertainty.
