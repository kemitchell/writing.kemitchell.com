...
Ask a lawyer what to do from there, and they'll mention unfair competition claims, as a kind of legal fallback.  Complaints, the legal documents people file to start lawsuits, include both all the time.  If the relatively hard-and-fast trademark claim fails, the comparatively fuzzy legal standards for the competition claims can keep the lawsuit alive, and convince the other side to settle with a promise to stop saying what you don't want them to say.
