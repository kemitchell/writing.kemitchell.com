...
If you can't go to a store, Brannock devices can be had online.  They aren't super cheap.  For one-off sessions, you can measure your feet in inches with a ruler and [convert with a table I put online](https://narrowwidthshoes.kemitchell.com/sizing).  Watch a YouTube video or two on how to use a Brannock device, then approximate.
