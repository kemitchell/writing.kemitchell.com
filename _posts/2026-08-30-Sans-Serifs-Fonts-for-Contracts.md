...
description: a systematic search
...
A good sans-serif font for contract proposals in Microsoft Word should:
- read easily
...
- Verdana, designed for reading on old low-resolution screens

Arial and Verdana were among Microsoft's [Core Fonts for the Web](https://en.wikipedia.org/wiki/TrueType_core_fonts_for_the_Web), so are widely available for free download on Linux and other systems.
